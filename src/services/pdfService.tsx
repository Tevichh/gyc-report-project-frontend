...
export async function generarReportePDF(reporte: any, map?: string[]) {
    const doc = (
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerRight}>
                        <Image style={styles.logo} src="./src/assets/logogyc.png" />
                    </View>
                </View>
                ...
                <Text style={[styles.sectionHeader, { backgroundColor: "#D9E1F2", color: "black", justifyContent: "center" }]}>
                ...
                <View
                    style={{
                        ...
                        gap: 5 // opcional, React-PDF puede no soportar gap, si no funciona usa margin
                    }}
                >
                    {map && map.length > 0 ? (
                        map.map((src, idx) => (
                            <Image
                                ...
                                src={src}
                                style={{
                                    width: "30%",  // ajusta a 2-3 por fila (30% para 3, 45% para 2)
                                    height: "120px",
                                    margin: 5
                                }}
                            />
